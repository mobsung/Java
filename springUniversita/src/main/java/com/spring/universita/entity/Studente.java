...
public class Studente {
	...
	public Studente(String nome, String cognome, String indirizzo, LocalDate anno_nascita, LocalDate anno_immatricolazione,
			int matricola) {
		super();
		this.nome = nome;
	...
	public Studente(StudenteDTO dto) {
		this.nome = dto.getNome();
		this.cognome = dto.getCognome();
		this.indirizzo = dto.getIndirizzo();
		this.anno_nascita = dto.getAnno_nascita();
		this.anno_immatricolazione = dto.getAnno_immatricolazione();
